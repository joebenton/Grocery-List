...
class RegisterViewController: UIViewController, StoryboardBased, ViewModelBased {
    ...
    func toggleRegisterBtnLoading(loading: Bool) {
        registerBtn.toggleLoading(loading: loading)
    }
